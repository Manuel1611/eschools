  ...
  <q-page class="auth-container">
    ...
    <div class="contenedor">
      ...
      <div class="contenido">
        ...
        <div class="text">
          E-Schools te informa sobre su Política de Privacidad respecto del
          ...
          contratación de servicios a través del sitio Web E-Schools<br /><br />
          ...
          personas físicas (RGPD).<br /><br />
          El uso de sitio Web implica la aceptación de esta Política de
          Privacidad así como las condiciones incluidas en las condiciones de
          uso
          <span class="ver-otro" @click="goOtro">(ver condiciones de uso)</span
          >.<br />
          ...
          <ul>
            ...
            <li>
              <strong
                >Principio de limitación del plazo de conservación:</strong
              >
              Los datos se mantendrán durante el tiempo estrictamente necesario
              para el fin o los fines del tratamiento. El Titular te informará
              del plazo de conservación correspondiente según la finalidad. En
              el caso de suscripciones, el Titular revisará periódicamente las
              listas y eliminará aquellos registros inactivos durante un tiempo
              considerable.
            </li>
            <li>
          ...
          E-Schools junto con la prueba válida en derecho como una fotocopia del
          D.N.I. o equivalente.<br /><br />
          ...
          presente Política de Privacidad.<br /><br />
          ...
          <ul>
            <li>
              ...
              Aviso Legal y en la ley aplicable. Esto puede incluir el
          ...
          alteración o destrucción de los mismos.<br /><br />
          El sitio Web está alojado en "asdasd". La seguridad de tus datos está
